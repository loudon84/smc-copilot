...
updated_at: 2026-09-08T01:45:00.000000Z
...
| RM-09 | M6c P1 Approval decision：可操作批准/拒绝卡片。 | RM-08 | IN_PRD | Provider v1.3.0 已关闭 Approval decision 合同；独立 Stage PRD 后实施 IPC/卡片。Attachment 仍 `unsupported`。 | docs/work/PRD-WORK-v4.0.1-M6-approval-decision.md | - | - | - |
