#!/usr/bin/env python3
"""Export Runtime FastAPI OpenAPI document to contracts/runtime-api/openapi.yaml."""
...
OUT = ROOT / "contracts" / "runtime-api" / "openapi.yaml"
...
def main() -> int:
    ...
    # Stable, machine-diffable output
    ...
    print(f"[export_openapi] wrote {OUT.relative_to(ROOT)}")
    return 0
