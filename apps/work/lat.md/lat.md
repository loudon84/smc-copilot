...
- [[registry-endpoint-configuration]] — the approved v4.1.1 target for one complete, source-aware Discover Registry descriptor; implementation remains governed by its Roadmap.
