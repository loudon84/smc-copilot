# SMC Copilot account login

Signs the desktop app into a SMC Copilot account (on `hermes-one-backend`),
...
[[src/renderer/src/screens/Providers/Providers.tsx]] hosts the "SMC Copilot
