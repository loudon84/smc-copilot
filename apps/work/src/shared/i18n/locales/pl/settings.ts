export default {
  ...
  analytics: {
    ...
    hint: "Pomaga ulepszać SMC Copilot przez wysyłanie anonimowych, zagregowanych danych użycia do usługi analitycznej projektu. Możesz to wyłączyć w dowolnym momencie.",
    disclosure: {
