export default {
  ...
  analytics: {
    ...
    hint: "تُجمع بشكل مجهول وتُستخدم فقط لتحسين SMC Copilot — أبداً محادثاتك أو ملفاتك أو أوامرك أو أي بيانات شخصية.",
  },
  ...
  autoUpgradeDesktopHint:
    "تنزيل إصدارات SMC Copilot الجديدة من GitHub تلقائياً عند بدء التطبيق. أوقف هذا لإظهار زر الترقية عند بدء التشغيل دون تنزيل حتى تنقر عليه.",
  ...
  communityLinksHint:
    "تواصل مع مجتمع SMC Copilot، واحصل على المساعدة، وابق على اطلاع.",
  linkWebsite: "الموقع",
  linkDiscord: "Discord",
  linkX: "X",
  ...
  supportHint:
    "SMC Copilot مجاني ومفتوح المصدر — إذا كان مفيداً لك، فكر في دعم تطويره.",
