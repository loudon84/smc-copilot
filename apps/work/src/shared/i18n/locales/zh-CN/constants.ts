export default {
  ...
  hermesoneApiKey: "SMC Copilot API Key",
  hermesoneHint: "SMC Copilot Inference — 基于额度的高速网关",
  ...
  nousHint:
    "Nous Portal API Key — 若你有 Nous 订阅，请改用下方的 OAuth 卡片",
  ...
  atlascloudHint: "通过 AtlasCloud 使用 Claude、GPT 与开放模型",
  ...
  auxiliaryDescription:
    "辅助任务处理视觉、压缩和网页提取等旁路工作。auto 表示「使用主模型」。当你希望为特定任务使用更便宜/更快的模型时，可按任务覆盖。",
  auxiliaryResetAll: "全部重置为 auto",
  auxiliaryVision: "视觉",
  auxiliaryVisionHint: "图片/截图分析",
  auxiliaryWebExtract: "网页提取",
  auxiliaryWebExtractHint: "网页摘要",
  auxiliaryCompression: "压缩",
  auxiliaryCompressionHint: "上下文摘要",
  auxiliarySkillsHub: "技能中心",
  auxiliarySkillsHubHint: "技能搜索/安装",
  ...
  auxiliaryTriageSpecifier: "分类细化器",
  auxiliaryTriageSpecifierHint: "看板规格展开",
  auxiliaryKanbanDecomposer: "看板分解器",
  auxiliaryKanbanDecomposerHint: "任务分解",
  auxiliaryProfileDescriber: "档案描述器",
  auxiliaryProfileDescriberHint: "自动生成档案描述",
  auxiliaryCurator: "策展器",
  ...
  auxiliaryResetSuccess: "所有辅助任务已重置为 auto",
