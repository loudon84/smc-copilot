export default {
  ...
  analytics: {
    ...
    hint: "Collected anonymously and used only to improve SMC Copilot ? never your chats, files, prompts, or any personal data.",
  },
  ...
  autoUpgradeDesktopHint:
    "Automatically download new SMC Copilot releases from GitHub when the app starts. Turn this off to show the startup upgrade button without downloading until you click it.",
  ...
  communityLinksHint:
    "Connect with the SMC Copilot community, get help, and stay up to date.",
  linkWebsite: "Website",
  linkDiscord: "Discord",
  linkX: "X",
  ...
  supportHint:
    "SMC Copilot is free and open source ? if it helps you, consider supporting its development.",
