export default {
  ...
  hermesAccount: {
    sectionTitle: "SMC Copilot account",
    sectionHint:
      "Sign in to your SMC Copilot account to sync agents, workspaces, and wallets across devices.",
    signIn: "Sign in to SMC Copilot",
    signOut: "Sign out",
    ...
    creditsTitle:
      "AI Credits available on your SMC Copilot account (1 credit = $1). Top up in the SMC Copilot console.",
    modalTitle: "Sign in to SMC Copilot",
