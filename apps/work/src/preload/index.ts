...
const hermesAPI = {
  ...
  // Auto-provision a SMC Copilot Inference key from the signed-in account
  ...
  // Cloud agent sync (profiles �?signed-in SMC Copilot account)
  ...
  > => ipcRenderer.invoke("list-configured-models", profile),
