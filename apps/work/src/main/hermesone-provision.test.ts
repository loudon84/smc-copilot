...
// Unit tests for the SMC Copilot convenience layer: auto-provisioning the
...
describe("hermesone provisioning", () => {
  ...
  // @lat: [[hermes-account-login#SMC Copilot account login#Auto-provisioned inference key and credits#Issues a key only when missing]]
  ...
  // @lat: [[hermes-account-login#SMC Copilot account login#Auto-provisioned inference key and credits#Provisions and persists a fresh key]]
  ...
  // @lat: [[hermes-account-login#SMC Copilot account login#Auto-provisioned inference key and credits#Single-flight provisioning]]
  ...
  // @lat: [[hermes-account-login#SMC Copilot account login#Auto-provisioned inference key and credits#Credits for the account card]]
