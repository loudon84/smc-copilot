...
This lab creates a disposable remote Hermes target for the sandboxed SMC Copilot instance without
touching the normal SMC Copilot worktree, config, or database.
...
## SMC Copilot Sandbox Settings

After `configure-desktop`, the sandboxed SMC Copilot instance is set to:
