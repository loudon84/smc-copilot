...
describe("dashboardModelMatches", () => {
  ...
  it("accepts Hermes Agent custom provider slugs for SMC Copilot custom rows", () => {
    expect(
...
describe("resolveDashboardProviderForModel", () => {
  it("maps SMC Copilot custom rows on known built-in endpoints to dashboard built-in providers", () => {
    expect(
      resolveDashboardProviderForModel(
        "custom",
        "deepseek-v4-pro",
  ...
  // sent the SMC Copilot model to the Nous proxy (404 "not in our configuration
  ...
  it("resolves SMC Copilot custom rows to dashboard custom provider slugs by base URL", () => {
    expect(
      resolveDashboardProviderForModel(
        "custom",
        "deepseek-v4-pro",
