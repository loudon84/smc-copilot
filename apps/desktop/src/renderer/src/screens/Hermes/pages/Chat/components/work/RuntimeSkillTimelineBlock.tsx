...
import { RuntimeSkillArtifactCard } from "./RuntimeSkillArtifactCard";
...
export function RuntimeSkillTimelineBlock({ entry, onPreviewArtifact, onDownloadArtifact }: Props) {
  ...
  return (
    <div className="hermes-expert-task-timeline hermes-runtime-skill-timeline" data-status={entry.status}>
      <div className="hermes-expert-task-timeline__header">
        <StatusIcon status={entry.status} />
        <div className="hermes-expert-task-timeline__title-wrap">
          <p className="hermes-expert-task-timeline__title">
            Runtime Skill {STATUS_LABEL[entry.status]}
          </p>
          <p className="hermes-expert-task-timeline__meta">
            {entry.expertName ? `${entry.expertName}` : "Runtime"}
      ...
      {entry.events.some((e) => e.type === "task.started") ? (
        <p className="hermes-expert-task-timeline__line">Runtime Skill task started</p>
      ) : null}
