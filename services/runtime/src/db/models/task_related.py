...
class TeamTaskBinding(Base):
    ...
    local_task_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("local_tasks.id", ondelete="CASCADE"), nullable=True)
    work_task_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("work_tasks.id", ondelete="CASCADE"), nullable=True)
