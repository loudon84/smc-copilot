...
class HermesInstance(Base):
    ...
    # PRD v1.5 Hermes Supervisor observed/desired state
    desired_state: Mapped[str] = mapped_column(String(32), nullable=False, default="stopped")
    process_state: Mapped[str] = mapped_column(String(32), nullable=False, default="unknown")
    api_state: Mapped[str] = mapped_column(String(32), nullable=False, default="unknown")
    ownership_state: Mapped[str] = mapped_column(String(32), nullable=False, default="unknown")
    ...
    consecutive_health_successes: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    restart_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    last_error_code: Mapped[str | None] = mapped_column(String(64), nullable=True)
    # PRD v1.5.1 persistent Gateway fingerprint
    gateway_executable_path: Mapped[str | None] = mapped_column(String(1024), nullable=True)
    gateway_command_hash: Mapped[str | None] = mapped_column(String(128), nullable=True)
