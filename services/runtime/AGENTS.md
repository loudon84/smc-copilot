...
- **v1.5.4:** Execution model catalog SOT is Hermes `/api/model/options` + `config.yaml`; Gateway `/v1/models` is virtual-model diagnostics only (never Desktop picker / model-config seed).
