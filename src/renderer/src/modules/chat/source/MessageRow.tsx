...
import type { MessageDocumentPreviewInput } from "@shared/chat-files";
...
interface MessageRowProps {
  ...
  /** DOM id for prompt-navigator jump targets (user bubbles only). */
  anchorId?: string;
}
...
export const MessageRow = memo(function MessageRow({
  ...
  return (
    <div
      id={anchorId}
      data-user-prompt-anchor={msg.role === "user" ? msg.id : undefined}
